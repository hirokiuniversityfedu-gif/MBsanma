  ...
  function buildRuleOverlayTabData(){
    ...
    return [
        ...
        cards: [
          ...
          },
          {
            ...
            lines: [
              ...
              { strong: "白ポッチ", text: boolOnOff("tiles-shiro-pocchi", "採用", "不採用", false) },
      ...
      },
      {
        ...
        footnote: `萬子のホンイツ：${formatChoiceValue(value("yaku-local-manzu-honitsu", "yakuman"), { off: "なし", baiman: "倍満", yakuman: "役満" }, "役満")}`
      }
    ];
  }
