...
function renderCpuHands(){
  ...
  const winnerSeat =
    (typeof lastAgariWinnerSeatIndex !== "undefined")
...
function renderCpuRivers(){
  const leftDeclareId =
    (typeof getCpuRiichiDeclareTileIdBySeat === "function")
      ? getCpuRiichiDeclareTileIdBySeat(2)
      : null;

  const rightDeclareId =
    (typeof getCpuRiichiDeclareTileIdBySeat === "function")
      ? getCpuRiichiDeclareTileIdBySeat(1)
      : null;
