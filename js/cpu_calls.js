...
function __cpuCallBuildOpenMeld(type, code, from, removedTiles, calledTile){
...
function executeCpuMinkan(seatIndex, discarderSeatIndex, discardedTile){
  ...
  meldRef.push(__cpuCallBuildOpenMeld("minkan", discardedTile.code, relativeFrom, removedTiles, calledTile));
...
function executeCpuPon(seatIndex, discarderSeatIndex, discardedTile){
  ...
  meldRef.push(__cpuCallBuildOpenMeld("pon", discardedTile.code, relativeFrom, removedTiles, calledTile));
